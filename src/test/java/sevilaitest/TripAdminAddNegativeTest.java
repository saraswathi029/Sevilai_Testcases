package sevilaitest;
	...
	public class TripAdminAddNegativeTest {
	    ...
	    @DataProvider(name = "negativeTestTripadminAdd")
	    public Object[][] provideTestData() {
	        return new Object[][] {
	            {"", "admin@gmail.com", "12345600", "TAA_TC_01", "Name is required"}, // Empty name
	            {"Test1", "admin@gmail.com", "12345600", "TAA_TC_02", "Enter a valid name"}, // Invalid name
	            {"@#$@", "admin@gmail.com", "12345600", "TAA_TC_03", "Enter a valid name"}, // Empty name
	            {"Tripadmin", "abc", "12345600", "TAA_TC_04", "Enter a valid email"}, // Invalid email
	            {"Tripadmin", "saraswathi.m@kaditinnovations.com", "12345600", "TAA_TC_05", "Admin email is already exists"}, // Existing email
	            {"Tripadmin", "admin@gmail.com", "", "TAA_TC_06", "Phone Number is required"}, // Missing phone number
	            {"Tripadmin", "admin@gmail.com", "1234", "TAA_TC_07", "Enter a valid phone number"}, // Invalid phone number
	            {"Tripadmin", "admin@gmail.com", "1234567891", "TAA_TC_08", "Enter a valid phone number"}, // Invalid phone number
	            {"Tripadmin", "admin@gmail.com", "12345678", "TAA_TC_09", "Admin Phone number is already exists"}, // Duplicate phone number
	            {"", "", "","", "TAA_TC_10", "Name is required, Email is required, Phone Number is required,Admin Type is required"} // All fields empty
	        };
	    }

	    @Test(dataProvider = "negativeTestTripadminAdd", description = "Validate error messages for negative scenarios")

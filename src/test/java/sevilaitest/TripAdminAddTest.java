...
public class TripAdminAddTest extends LoginTest {
    
    @Test(description = "TAA_TC_01: Validate Admin is added successfully")
    public void superadmin() throws Throwable {
        String testCaseID = "TAA_TC_01"; // Assign test case ID
        
        WebElement AdminTab = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(),'Tab 5 of 5')]")));
        AdminTab.click();
        ...
        String[][] adminData = {
            {"Trip", "trip@gmail.com", "11112323", "TRIP_ADMIN"},
            {"Trp", "trp2@gmail.com", "11112322", "TRIP_ADMIN"}
        };
